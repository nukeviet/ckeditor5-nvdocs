...
export default class NVDocsEditing extends Plugin {
	...
	private _setupConversion(): void {
		...
		conversion.for( 'upcast' )
			// Upcast cấu trúc div.nvck-docs
			.add( upcastNVDocsDivStructure( nvDocsUtils, editor ) )
			// Upcast cấu trúc nv-docviewer cũ của ckeditor4 thành model nvdocs ckeditor5
			.add( upcastV4NVDocviewer( nvDocsUtils, editor ) );
	}
}
